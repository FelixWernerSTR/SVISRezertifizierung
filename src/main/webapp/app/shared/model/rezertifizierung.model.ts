export interface IRezertifizierung {
  ...
  bestandssicht?: string | null;
  bemerkung?: string | null;
  pruefungErfolgt?: boolean | null;
}
...
export class Rezertifizierung implements IRezertifizierung {
  constructor(
    ...
    public bestandssicht?: string | null,
    public bemerkung?: string | null,
    public pruefungErfolgt?: boolean | null
  ) {
    this.pruefungErfolgt = this.pruefungErfolgt ?? false;
  }
}
