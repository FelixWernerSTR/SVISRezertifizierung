  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="svisAktuellesApp.thema.home.createOrEditLabel"
          data-cy="ThemaCreateUpdateHeading"
          v-text="$t('svisAktuellesApp.thema.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisAktuellesApp.thema.name')" for="thema-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisAktuellesApp.thema.rechte')" for="thema-rechte">Rechte</label>
            <input
              type="text"
              class="form-control"
              name="rechte"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisAktuellesApp.thema.displaycount')" for="thema-displaycount"
              >Displaycount</label
            >
            <input
              type="number"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisAktuellesApp.thema.thementyp')" for="thema-thementyp">Thementyp</label>
