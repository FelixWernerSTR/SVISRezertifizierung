      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('svisRezertifizierungApp.rezertifizierung.bestandssicht')"
              for="rezertifizierung-bestandssicht"
              >Bestandssicht</label
            >
            <textarea
              class="form-control"
              name="bestandssicht"
              id="rezertifizierung-bestandssicht"
              data-cy="bestandssicht"
              :class="{ valid: !$v.rezertifizierung.bestandssicht.$invalid, invalid: $v.rezertifizierung.bestandssicht.$invalid }"
              v-model="$v.rezertifizierung.bestandssicht.$model"
            ></textarea>
          </div>
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('svisRezertifizierungApp.rezertifizierung.bemerkung')"
              for="rezertifizierung-bemerkung"
              >Bemerkung</label
            >
            <textarea
              class="form-control"
              name="bemerkung"
              id="rezertifizierung-bemerkung"
              data-cy="bemerkung"
              :class="{ valid: !$v.rezertifizierung.bemerkung.$invalid, invalid: $v.rezertifizierung.bemerkung.$invalid }"
              v-model="$v.rezertifizierung.bemerkung.$model"
            ></textarea>
          </div>
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('svisRezertifizierungApp.rezertifizierung.pruefungErfolgt')"
              for="rezertifizierung-pruefungErfolgt"
              >Pruefung Erfolgt</label
            >
            <input
              type="checkbox"
              class="form-check"
              name="pruefungErfolgt"
              id="rezertifizierung-pruefungErfolgt"
              data-cy="pruefungErfolgt"
              :class="{ valid: !$v.rezertifizierung.pruefungErfolgt.$invalid, invalid: $v.rezertifizierung.pruefungErfolgt.$invalid }"
              v-model="$v.rezertifizierung.pruefungErfolgt.$model"
            />
          </div>
        </div>
        <div>
