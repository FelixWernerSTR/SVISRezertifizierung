    ...
    public Optional<Rezertifizierung> partialUpdate(Rezertifizierung rezertifizierung) {
        ...
        return rezertifizierungRepository
            ...
            .map(existingRezertifizierung -> {
                ...
                if (rezertifizierung.getBestandssicht() != null) {
                    existingRezertifizierung.setBestandssicht(rezertifizierung.getBestandssicht());
                }
                if (rezertifizierung.getBemerkung() != null) {
                    existingRezertifizierung.setBemerkung(rezertifizierung.getBemerkung());
                }
                if (rezertifizierung.getPruefungErfolgt() != null) {
                    existingRezertifizierung.setPruefungErfolgt(rezertifizierung.getPruefungErfolgt());
                }
