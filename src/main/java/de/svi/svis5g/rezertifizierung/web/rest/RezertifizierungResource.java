...
public class RezertifizierungResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/rezertifizierungs/{id}", consumes = { "application/json", "application/merge-patch+json" })
    ...
    public ResponseEntity<List<Rezertifizierung>> getAllRezertifizierungs(
